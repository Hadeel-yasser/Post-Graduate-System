...
namespace Admin
{
    public partial class Examiner_Search_Thesis : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand ExaminerSearch = new SqlCommand("ExaminerSearch", conn);
            ExaminerSearch.CommandType = CommandType.StoredProcedure;


            ExaminerSearch.Parameters.Add(new SqlParameter("@keyword", SqlDbType.VarChar)).Value = Keyword;

            SqlParameter success = ExaminerSearch.Parameters.Add("@success", SqlDbType.Bit);
            success.Direction = ParameterDirection.Output;

            conn.Open();
            ExaminerSearch.ExecuteNonQuery();
            SqlDataReader rdr = ExaminerSearch.ExecuteReader(CommandBehavior.CloseConnection);
           ...
           // }
            //else
            //{
              //  Response.Write("<script type=\"text/javascript\">alert('Entered keyword doesn't exist');</script>");
            //}
            conn.Close();
        }
    }
